...
<html><head>
	...
	<!--当前人员-->
		<div id="people" class="Gallery">
			<div class="container">
				<?php
					$sql = "select * from v_signtable where laboratoryid=".$laboratoryid." and static = 1 and to_days(intime) = to_days(now())  group by stuname";
					$row = $db->findAll($sql);
				 ?>
				...
				<div class="section group">
					<?php 
						for($i=0;$i<count($row);$i++){
							echo "<div class='col-xs-3'><center><img src='./images/user.png' width='80px' height='80px' /><h4>".$row[$i]['stuname']."</h4></center></div>";
						}
					 ?>
                </div>
		</div>
